...
#############################################################
#
# Adapted version of argonone-config 
#
# Added option to set fan thresholds to default.
#
# Ashley Strahle
# 2/5/2020
#
...
do
	...
	echo "  1. Set to default"
	echo "  2. Always on"
	echo "  3. Adjust to temperatures (55C, 60C, and 65C)"
	echo "  4. Customize behavior"
	echo "  5. Cancel"
